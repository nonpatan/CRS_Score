...
(function () {
  ...
  const MODULES = {
    ...
    personnel: {
      ...
      hrOnly: ["index.html", "leave.html", "duty.html", "staff.html", "hr-settings.html", "work-summary.html"],
      groups: [
        {
          label: "บันทึก",
          items: [
            ["leave.html", "บันทึกการลา"],
            ["duty.html", "ตารางเวรรับนักเรียน"]
          ]
        },
        {
          label: "กำหนดค่า",
      ...
      workflows: {
        ...
        "duty.html": {
          title: "จัดเวรรับนักเรียน",
          description: "กำหนดรูปแบบประจำสัปดาห์ แล้วสร้างหรือสลับเวรจริงของเดือน",
          steps: ["ตั้งรูปแบบ", "สร้างรายเดือน", "ตรวจและสลับเวร"]
        },
        "staff.html": {
