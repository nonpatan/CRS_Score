    ...
    academic: {
      ...
      groups: [
        {
          ...
          items: [
            ...
            ["activities.html", "กิจกรรมพัฒนาผู้เรียน"]
          ]
        },
        {
          label: "กำหนดค่า",
      ...
      workflows: {
        ...
        "competency-core.html": {
          ...
          description: "ตั้งน้ำหนัก 3 แหล่งและเกณฑ์แปลผลกลางที่ใช้ร่วมกันทั้ง 6 ด้าน",
          steps: ["ตั้งน้ำหนัก", "ตั้งเกณฑ์", "บันทึก"]
        },
        ...
        "activities.html": {
          title: "บันทึกผลกิจกรรมพัฒนาผู้เรียน",
          description: "เลือกกิจกรรม ตรวจรายชื่อนักเรียน แล้วบันทึกผลผ่านหรือไม่ผ่าน",
          steps: ["เลือกกิจกรรม", "ลงทะเบียน", "ติ๊กผล"]
        }
      }
    },
